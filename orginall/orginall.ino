...
int ch1Val, ch2Val, ch6Val, Speed=190;
...
void loop() {
  ...
  if (ch6Val <= 1500){ // ON
    ...
    if(ch2Val>=1600 && ch2Val<=1850) forward();
    else if(ch2Val>=1250 && ch2Val<=1500)back(); 
    else if(ch1Val<=1500 && ch1Val>=1250)right();
    else if(ch1Val>=1600 && ch1Val<=1850)left();
    else Stop();
  }
}
